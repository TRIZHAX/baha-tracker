...
export function LoginScreen() {
  ...
  const continueAsGuest = () => {
    window.localStorage.setItem("baha-guest", "true")
    router.push("/map")
  }
    ...
    <main className="grid min-h-dvh bg-[hsl(var(--background))] lg:grid-cols-[1.1fr_0.9fr]">
      ...
      <section className="relative flex items-center justify-center p-5 sm:p-10">
        ...
        <div className="w-full max-w-md animate-rise">
          ...
          <div className="my-6 flex items-center gap-3 text-xs font-bold uppercase tracking-wider text-[hsl(var(--muted-foreground))]"><span className="h-px flex-1 bg-[hsl(var(--border))]" />or<span className="h-px flex-1 bg-[hsl(var(--border))]" /></div>
          <Button variant="secondary" className="w-full" onClick={continueAsGuest}><MapPin className="h-5 w-5" />Continue as guest</Button>
