...
import { AdminSosMap } from "@/components/admin-sos-map"
...
type Sos = { id: string; user_id: string | null; longitude: number; latitude: number; accuracy_meters: number | null; emergency_types: string[]; status: string; created_at: string; acknowledged_at: string | null; updated_at: string }
